...
Course::Course(int code, weekday day1, weekday day2, int stime, int etime,
               int* prerequisites, int pre_num):course_code(code),lecture_time(day1,day2,stime,etime)
{

	for(int i=0;i<pre_num;i++){
		//cerr<<"adding pre_requisite..."<<i<<endl; //remove this line

		pre_requisites.push_back(prerequisites[i]);
		//cerr<<"added pre_requisite"<<i<<endl; //remove this line
	}
}
